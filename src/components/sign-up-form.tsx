...
export function SignupFormDemo() {
  ...
  return (
    <div className="max-w-2xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-black bg-opacity-75 hover:bg-opacity-80 dark:bg-black">
      <div className="flex flex-col items-center text-center"> {/* Center-align the text */}
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        >
          ...
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-[#5865F2] px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
            <IconBrandDiscord className="h-4 w-4 text-white" />
            <span className="text-white text-sm text-center pl-2">
              Discord
            </span>
          </span>
        </button>
